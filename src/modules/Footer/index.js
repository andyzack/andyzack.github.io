...
import logoPlay from '../../assets/images/logo-javaplay.png';
...
import logoAbstract from '../../assets/images/logo-abstract.png';
...
<footer className="w-100 bg-black-60">
  <div className="mw8 w-100 center dt">
    <div className="tc db mt3">
      ...
      <img
        src={logoPlay}
        className="aaz-icon-javaplay w2 bg-black-30 br-100 b--dark-gray ba pa1 ma1"
        alt="JavaPlay"
      />
      <img
        src={logoGitlogo}
      ...
      <img
        src={logoAdobe}
        className="aaz-icon-adobe w2 bg-black-30 br-100 b--dark-gray ba pa1 ma1"
        alt="Adobe"
      />
      <img
        src={logoInvision}
        className="aaz-icon-invision w2 bg-black-30 br-100 b--dark-gray ba pa1 ma1"
        alt="invision"
      />
      <img
        src={logoAbstract}
        className="aaz-icon-abstract w2 bg-black-30 br-100 b--dark-gray ba pa1 ma1"
        alt="abstract"
      />
    </div>
